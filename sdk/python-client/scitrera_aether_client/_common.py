...
# Exact-target behavior while the target identity is disconnected.
TARGET_OFFLINE_UNSPECIFIED = aether_pb2.TARGET_OFFLINE_POLICY_UNSPECIFIED
TARGET_OFFLINE_ORCHESTRATE = aether_pb2.TARGET_OFFLINE_POLICY_ORCHESTRATE
TARGET_OFFLINE_QUEUE = aether_pb2.TARGET_OFFLINE_POLICY_QUEUE
TARGET_OFFLINE_REJECT = aether_pb2.TARGET_OFFLINE_POLICY_REJECT

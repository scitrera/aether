...
class BaseAsyncAetherClient:
    ...
    def __init__(self,
        ...
        self.on_task_event: Optional[Callable] = None
            ...
            async for response in self._stream:
                ...
                if payload_type == "msg":
                    ...
                    if self.on_task_event:
                        asyncio.create_task(_safe_callback(self.on_task_event, response.task_event))
    ...
    async def check_access(self, access: aether_pb2.ResourceAccessRequest,
        ...
        response = await self._send_sync_op(
    ...
    async def batch_check_access(self, access: List[aether_pb2.ResourceAccessRequest],
                                 authorization: Optional[aether_pb2.AuthorizationContext] = None,
                                 timeout: float = 10.0):
    ...
    def register_task_event_handler(self, handler: Callable) -> None:
        """
        ...
        The handler may be a plain callable or a coroutine function — the
        listen loop dispatches it via asyncio.create_task(_safe_callback(...))
        so it runs concurrently without blocking event delivery.

        Args:
            handler: Callable (sync or async) that accepts a TaskEvent proto.
        """
    ...
    async def register_agent(self, implementation: str,
                             ...
                             resource_schema: list[aether_pb2.AgentResourceSchemaEntry] | None = None,
    ...
    async def update_agent(self, implementation: str,
                           profile: str = "local",
                           description: str = "",
                           launch_params: dict[str, str] | None = None,
                           resource_schema: list[aether_pb2.AgentResourceSchemaEntry] | None = None,

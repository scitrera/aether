...
export interface BatchAccessCheckOperation {
  'requestId'?: (string);
  'access'?: (_aether_v1_ResourceAccessRequest)[];
  'authorization'?: (_aether_v1_AuthorizationContext | null);
}

export interface BatchAccessCheckOperation__Output {
  'requestId': (string);
  'access': (_aether_v1_ResourceAccessRequest__Output)[];
